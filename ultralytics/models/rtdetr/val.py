...
# === 🟢 [W-RT-DETR 修复] 添加这个函数用于替换 lambda ===
def _add_padding_info(x):
    """Windows multiprocessing safe transform function."""
...
class RTDETRDataset(YOLODataset):
    ...
    def build_transforms(self, hyp=None):
        ...
        if self.augment:
            ...
            # === 🟢 [W-RT-DETR 修复] 使用定义好的函数替代 lambda ===
            transforms = Compose([_add_padding_info])
            # ====================================================
        transforms.append(
            Format(
                bbox_format="xywh",
