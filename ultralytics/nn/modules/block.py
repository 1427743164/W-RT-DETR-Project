...
# =======================================================
# 🟢 [W-RT-DETR 自定义模块植入]
# 1. 动态获取项目根目录 (这样你把项目拷到别的电脑也能跑，不用改路径)
#    (block.py 在 ultralytics/nn/modules，往上跳 3 级就是根目录)
...
# 3. 从你的 models 文件夹导入小波模块
#    (对应你项目里的 models/wavelet.py)
try:
    from models.wavelet import HaarWaveletDownsampling, FrequencyAwareFusion,WaveletUpsample
    print(f"✅ [W-RT-DETR] 成功加载自定义小波模块: {project_root}")
except ImportError as e:
    print(f"❌ [W-RT-DETR] 加载失败，请检查路径: {e}")
# =======================================================
